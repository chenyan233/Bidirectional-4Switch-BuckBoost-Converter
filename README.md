...
![图 1 四开关双向 Buck-Boost 功率拓扑与控制、采样及保护架构](assets/diagrams/fig01-power-stage-architecture.svg)

图 1 四开关双向 Buck-Boost 功率拓扑与控制、采样及保护架构
...
![图 2 电压外环、电流内环与调制监督控制](assets/diagrams/fig03-cascaded-control.svg)

图 2 电压外环、电流内环与调制监督控制
...
![图 3 Buck、交接区与 Boost 的桥臂调制方式及交接区开关状态](assets/diagrams/fig02-operating-regions.svg)

图 3 Buck、交接区与 Boost 的桥臂调制方式及交接区开关状态
...
图 4 四开关双向 Buck-Boost 的 PSIM 仿真模型
...
图 5 A 端 30 V 24 V 18 V 变化时的两端母线电压响应
...
图 9 B 端向 A 端传输时的 24 V 至 30 V Boost 响应
...
图 10 B 端向 A 端传输时的 24 V 至 18 V Buck 响应
