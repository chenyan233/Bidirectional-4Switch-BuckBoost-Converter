...
| **当前状态**     | **切换条件**                | **下一状态**     |
|------------------|-----------------------------|------------------|
| A桥高频，B桥直通 | $\varepsilon \leq + 10\%$ | 交界区           |
| 交界区           | $\varepsilon \geq + 11\%$ | A桥高频，B桥直通 |
| B桥高频，A桥直通 | $\varepsilon \geq - 10\%$ | 交界区           |
| 交界区           | $\varepsilon \leq - 11\%$ | B桥高频，A桥直通 |

这 1% 的差值主要是为了防止 $V_{A}$和 $V_{B}$在边界附近有纹波或者采样噪声时，状态机在 Buck 和交接区、或者 Boost 和交界区之间反复跳变。
